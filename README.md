# ![Terraform](https://img.shields.io/badge/terraform-%235835CC.svg?style=for-the-badge&logo=terraform&logoColor=white) GCP Cloud Run
...
*terragrunt.hcl*
```hcl
source = "git@github.com:ranson21/tf-gcp-cloud-run"
